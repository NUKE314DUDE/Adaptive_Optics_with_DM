...
from Zernike_Polynomials_Modules import min_circle, Zernike, image_padding_for_circular_area
...
reference_circle = min_circle(reference_coord, scale = 1.3)
...
for i, j in enumerate(input_zernike):
    ...
    # show_coord(current_zern_profile, padded_ref_coord + 6e5*current_coord_diff.reshape(128,2), padded_ref_circle)
    # plt.show()
    # input()
